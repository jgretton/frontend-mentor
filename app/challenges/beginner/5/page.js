      ...
      <article className="sm:rounded- mt-10 flex max-w-2xl flex-col overflow-hidden rounded-2xl bg-white sm:flex-row sm:items-center sm:justify-center">
        <figure className="sm:w-1/2">
          <Image
            ...
            alt="Gabrielle Chanel perfume bottle next to green leaves"
          />
          <Image
            src={DesktopImage}
            alt="Gabrielle Chanel perfume bottle next to green leaves"
        ...
        <section className="p-5 sm:w-1/2 sm:p-7">
          ...
          <div className="mt-6 flex items-center gap-5">
            <p className="text-4xl font-semibold text-[rgba(79,128,106,1)]">
              <span className="sr-only">Current discount price:</span>
              $149.99
            </p>
          ...
          <button
            type="button"
            className="mt-6 inline-flex w-full items-center justify-center gap-x-4 rounded-lg bg-[rgba(79,128,106,1)] py-4 font-semibold text-white transition-colors hover:bg-[rgba(36,63,50,1)]"
          >
